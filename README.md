...
| [home](https://github.com/communitybrisbane/home) | ブリスベンで0→1で立ち上げた国際交流イベント事業「Community Brisbane」の公式HP | HTML / CSS / JS |
...
- **学部**: 九州工業大学 工学部 マテリアル専攻（計算物質科学研究室・第一原理計算で半導体のキャリア輸送特性を研究）
- **休学**: 大学院入学翌日に休学し、海外へ
- **海外**: フィリピン語学留学 → オーストラリア（ブリスベン）でワーホリ 1.5 年。国際交流コミュニティを 0→1 で立ち上げ・運営
- **スキル習得**: ワーホリ期間に独学で Web 制作・AI 活用・GAS などを習得。「40時間集中学習法」で1分野を初心者から脱出させるのが習慣
- **現在**: 2026年4月復学（M1・溶接力学研究室）+ 個人開発の二刀流

---

## 🎯 強み

- **ゼロイチ実行**: アプリ・コミュニティ・LP・ガイドサイト など、全部 0 から一人で形にしてきた
- **横断学習**: フロント / バック / インフラ / デザイン / コピー / 運用 まで一通り触る
- **AI 活用前提の開発**: 仕様検討から実装まで AI を相棒に。スピード優先で量産

---

![Top Langs](https://github-readme-stats.vercel.app/api/top-langs/?username=communitybrisbane&layout=compact&theme=default)
